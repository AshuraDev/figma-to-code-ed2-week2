...
const HeroSection = () => {
  return (
    <div className="mt-10 flex items-center justify-center text-center w-full h-96 md:h-[460px] xl:h-[500px] bg-black/25 bg-[url('/images/hero_image.webp')] bg-cover bg-center bg-no-repeat rounded-[52px]">
      <div className="flex flex-col items-center p-0 gap-10">
        ...
        <div className="flex flex-row items-center justify-center ">
          <Button className="bg-white flex items-center justify-center py-3 px-5 text-sm font-semibold text-color_4 rounded-full hover:bg-color_2 hover:text-color_4">Start Shopping</Button>
